...
const addChildNodeinParentNodeById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const newFolder = yield folder_service_1.FolderService.addChildNodeinParentNodeById("653b4de3407359826ad118e6", // host root id 
    id, newChild);
    if (newFolder) {
...
const deleteNodeById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield folder_service_1.FolderService.deleteNodeById("653b4de3407359826ad118e6", id);
    if (result) {
